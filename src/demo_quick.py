...
print(f"\n{'='*50}")
print(f"  完成! 文件在:")
print(f"  {OUT}/story.html   - 故事 ({len(story)}字)")
print(f"  {OUT}/script.html  - 脚本 ({len(script)}字)")
print(f"  {OUT}/assets.html  - 资产 ({len(assets.get('assets',[]))}款)")
print(f"  {OUT}/proof.html   - 链上证明")
print(f"  {OUT}/nft/         - NFT合约")
print(f"{'='*50}")
